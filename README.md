...
services:
  postgres-json-keys:
    image: ghcr.io/a-novel/service-json-keys/database:v2.1.5
    networks:
      - api
    environment:
  ...
  service-json-keys:
    image: ghcr.io/a-novel/service-json-keys/standalone-grpc:v2.1.5
    ports:
...
services:
  ...
  migrations-json-keys:
    image: ghcr.io/a-novel/service-json-keys/migrations:v2.1.5
    depends_on:
      postgres-json-keys:
        condition: service_healthy
    environment:
  ...
  service-json-keys:
    image: ghcr.io/a-novel/service-json-keys/grpc:v2.1.5
    ports:
      - "${SERVICE_JSON_KEYS_GRPC_PORT}:8080"
    depends_on:
      postgres-json-keys:
...
services:
  ...
  service-json-keys:
    image: ghcr.io/a-novel/service-json-keys/standalone-rest:v2.1.5
    ports:
...
services:
  ...
  service-json-keys:
    image: ghcr.io/a-novel/service-json-keys/rest:v2.1.5
    ports:
      - "${SERVICE_JSON_KEYS_REST_PORT}:8080"
    depends_on:
      postgres-json-keys:
