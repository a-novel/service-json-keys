...
services:
  postgres-json-keys:
    image: ghcr.io/a-novel/service-json-keys/database:v2.6.0
    networks: [api]
    environment:
  ...
  service-json-keys:
    image: ghcr.io/a-novel/service-json-keys/grpc:v2.6.0 # or .../rest:v2.3.2 for the public REST API
...
services:
  ...
  service-json-keys:
    image: ghcr.io/a-novel/service-json-keys/standalone-grpc:v2.6.0 # or standalone-rest
